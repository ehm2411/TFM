...
```{r explmulti2,eval= FALSE,cache=TRUE}
par(mfrow=c(2,3))
...
```{r explmulti3,eval= FALSE,cache=TRUE}
...
```{r clu_1, eval=TRUE, warning= FALSE, eval = TRUE ,cache=TRUE}
library(cluster)
...
```{r clu_2, eval=TRUE, warning= FALSE, eval = FALSE ,cache=TRUE}
...
```{r clu_3, eval=TRUE, warning= FALSE, eval = TRUE ,cache=TRUE}
library(cluster)
...
```{r discr_1, eval=TRUE, warning= FALSE, eval = TRUE ,cache=TRUE}
# Alerta vs Diet
